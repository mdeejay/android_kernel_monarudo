...
static struct l2_level l2_freq_tbl_8064[] = {
	...
	[2]  = { {  384000, PLL_8, 0, 2, 0x00 }, 1050000, 1050000, 1 },
	[3]  = { {  432000, HFPLL, 2, 0, 0x20 }, 1050000, 1050000, 2 },
	[4]  = { {  486000, HFPLL, 2, 0, 0x24 }, 1050000, 1050000, 2 },
	[5]  = { {  540000, HFPLL, 2, 0, 0x28 }, 1050000, 1050000, 2 },
	[6]  = { {  594000, HFPLL, 1, 0, 0x16 }, 1050000, 1050000, 2 },
	[7]  = { {  648000, HFPLL, 1, 0, 0x18 }, 1050000, 1050000, 4 },
	[8]  = { {  702000, HFPLL, 1, 0, 0x1A }, 1050000, 1050000, 4 },
	[9]  = { {  756000, HFPLL, 1, 0, 0x1C }, 1150000, 1150000, 4 },
	[10] = { {  810000, HFPLL, 1, 0, 0x1E }, 1150000, 1150000, 4 },
	[11] = { {  864000, HFPLL, 1, 0, 0x20 }, 1150000, 1150000, 4 },
	[12] = { {  918000, HFPLL, 1, 0, 0x22 }, 1150000, 1150000, 7 },
	[13] = { {  972000, HFPLL, 1, 0, 0x24 }, 1150000, 1150000, 7 },
...
static struct acpu_level acpu_freq_tbl_8064_slow[] = {
	...
	{ 0, {   432000, HFPLL, 2, 0, 0x22 }, L2(7),   975000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   975000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),  1000000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),  1000000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),  1025000 },
	...
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(7),  1125000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(7),  1125000 },
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(17), 1175000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(17), 1175000 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(17), 1200000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(17), 1200000 },
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(17), 1225000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(17), 1225000 },
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(17), 1237500 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(17), 1237500 },
...
static struct acpu_level acpu_freq_tbl_8064_nom[] = {
	...
	{ 0, {   432000, HFPLL, 2, 0, 0x22 }, L2(7),   925000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   925000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),   950000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   950000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),   975000 },
	...
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(7),  1075000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(7),  1075000 },
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(17), 1125000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(17), 1125000 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(17), 1150000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(17), 1150000 },
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(17), 1175000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(17), 1175000 },
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(17), 1187500 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(17), 1187500 },
...
static struct acpu_level acpu_freq_tbl_8064_fast[] = {
	...
	{ 0, {   432000, HFPLL, 2, 0, 0x22 }, L2(7),   875000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   875000 },
	{ 0, {   540000, HFPLL, 2, 0, 0x28 }, L2(7),   900000 },
	{ 1, {   594000, HFPLL, 1, 0, 0x16 }, L2(7),   900000 },
	{ 0, {   648000, HFPLL, 1, 0, 0x18 }, L2(7),   925000 },
	...
	{ 0, {   972000, HFPLL, 1, 0, 0x24 }, L2(7),  1025000 },
	{ 1, {  1026000, HFPLL, 1, 0, 0x26 }, L2(7),  1025000 },
	{ 0, {  1080000, HFPLL, 1, 0, 0x28 }, L2(17), 1075000 },
	{ 1, {  1134000, HFPLL, 1, 0, 0x2A }, L2(17), 1075000 },
	{ 0, {  1188000, HFPLL, 1, 0, 0x2C }, L2(17), 1100000 },
	{ 1, {  1242000, HFPLL, 1, 0, 0x2E }, L2(17), 1100000 },
	{ 0, {  1296000, HFPLL, 1, 0, 0x30 }, L2(17), 1125000 },
	{ 1, {  1350000, HFPLL, 1, 0, 0x32 }, L2(17), 1125000 },
	{ 0, {  1404000, HFPLL, 1, 0, 0x34 }, L2(17), 1137500 },
	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(17), 1137500 },
	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(17), 1150000 },
...
unsigned long acpuclk_8960_power_collapse(void)
{
	...
	acpuclk_8960_set_rate(smp_processor_id(), 192000, SETRATE_PC);
	return rate;
}
